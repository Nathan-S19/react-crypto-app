  ...
  return (
    <div className='rounded-div my-12 py-8'>
      <div className='flex py-8'>
        <img className='mr-8 w-20' src={coin.image?.large} alt='/' />
        <div>
      ...
      <div className='grid gap-8 md:grid-cols-2'>
        <div>
          ...
          <div className='flex justify-between py-4'>
            ...
            <div>
              <div>
                <p className='text-right text-sm text-gray-500'>Volume (24h)</p>
      ...
      {/* Description */}
      <div className='py-4'>
        <p className='mb-2 text-xl font-bold'>About {coin.name}</p>
        <p
